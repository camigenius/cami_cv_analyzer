...
#     education : str = Field(description="Nivel educativo más alto y especialización principal del candidato.")
#     experiencia_relevante : str = Field(description="Resumen conciso de la experiencia mas relavente para el puesto específico.")
#     fortalezas : list[str] = Field(description="3-5 principales fortalezas del candidato basadas en su perfil.")
#     areas_mejora : list[str] = Field(description="2-4 áreas donde el candidato poodría desarrollarse o mejorar.")    
#     porcentaje_ajuste : int = Field(description="Porcentaje de ajuste al puesto (0-100)basado en la experiencia,habilidadaes y formación",ge=0,le=100)
...
class AnalisisCV(BaseModel):
    ...
    porcentaje_ajuste: int = Field(description="Porcetaje de ajuste al puesto (0-100) basado en experiencia, habilidades y formación.", ge=0, le=100)                                          
